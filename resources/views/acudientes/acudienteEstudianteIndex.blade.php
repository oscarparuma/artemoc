	...
	<div class="container">
		...
		@else
			<div class="alert alert-warning" role="alert">
				No hay acudientes asociados a {{ $estudiante->nombre . ' ' . $estudiante->apellido }}!
			</div>
		@endif
		<div>
			<a href="{{ url('acudientes/estudiante/' . $estudiante->id . '/create') }}" class="btn btn-primary pull-right">Registrar acudiente</a>
		</div>
	</div>
